...
<div class="col-sm-12">
  <section>
    ...
    $cosa = array (
      array('id', 'correct', 'almost-correct', 'doubtful', 'incorrect', 'opposite', 'no-aswer'),
      array($json_data['test']['pictogramas'][$a]['nombre'], $q1, $q2, $q3, $q4, $q5, $q6),
    );

      $fp = fopen('consolida3.csv', 'w');

      foreach ($cosa as $campos) {
          fputcsv($fp, $campos);
      }
